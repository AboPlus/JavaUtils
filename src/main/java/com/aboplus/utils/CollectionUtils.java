...
import com.aboplus.function.ObjectHandler;
import com.aboplus.function.ObjectProcess;
...
//    }
    ...
    public static <T> List<T> intersection(List<T> list1, List<T> list2) {
        if (CheckUtils.isNotBlack(list1, list2)) {
    ...
    public static <T> Set<T> intersection(Set<T> set1, Set<T> set2) {
        if (CheckUtils.isNotBlack(set1, set2)) {
    ...
    public static <T> Queue<T> intersection(Queue<T> queue1, Queue<T> queue2) {
        if (CheckUtils.isNotBlack(queue1, queue2)) {
    ...
    /**
     * Map集合的交集只提供键的交集，即如果key相同，则保留map1的value
     *
     * @param map1 map
     * @param map2 map
     * @param <K>  泛型
    ...
    public static <K, V> Map<K, V> intersection(Map<K, V> map1, Map<K, V> map2) {
        ...
        if (CheckUtils.isNotBlack(map1, map2)) {
    ...
    public static <T> List<T> subtract(List<T> list1, List<T> list2) {
        ...
        if (CheckUtils.isNotBlack(list1)) {
            list.addAll(list1);
    ...
    public static <T> Queue<T> subtract(Queue<T> queue1, Queue<T> queue2) {
        ...
        if (CheckUtils.isNotBlack(queue1)) {
            queue.addAll(queue1);
